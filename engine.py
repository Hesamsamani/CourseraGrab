...
from constants import (CLASS_URL, ABOUT_URL, PATH_CACHE)
from file_downloader import get_downloader
from course_builder import CourseraDownloader
from download_pool import ConsecutiveDownloader, ParallelDownloader
from helpers import (clean_filename, get_anchor_format, mkdir_p, fix_url,
                   print_ssl_error_message,
                   BeautifulSoup, is_debug_run,
                   spit_json, slurp_json)

from ondemand_api import expand_specializations
from net import get_page, get_page_and_url
from cli import parse_args
from syllabus import CourseraExtractor


# (Legacy library-version asserts removed; modern requests/bs4 are assumed.)
