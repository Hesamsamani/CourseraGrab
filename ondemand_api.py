...
from helpers import (BeautifulSoup, make_coursera_absolute_url,
                    extend_supplement_links, clean_url, clean_filename,
                    is_debug_run, unescape_html)
from net import get_reply, get_page, post_page_and_reply
from constants import (OPENCOURSE_SUPPLEMENT_URL,
...
from auth import prepare_auth_headers
